    ...
    <div className="question-details-container">
      ...
      <div>
        ...
        <div className="buttons">
          <button className="remettre" type="submit" onClick={handleReject}>Remettre en attente</button>
          <button className="approuver" type="submit" onClick={handleApprove}>Corriger</button>
        </div>
      </form>
    </div>
  );
